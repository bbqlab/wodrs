...
(function($) {
    ...
    (function() {
        ...
        this.tmpl = function tmpl(str, data) {
            console.log(data);
            // @todo L'eccezione qui viene lanciata perche data dovrebbe contenere running_opponent e invece contiene running.
            // Non so minimamente cosa voglia dire, voi sapete meglio di me :) mo vado a dormire.
